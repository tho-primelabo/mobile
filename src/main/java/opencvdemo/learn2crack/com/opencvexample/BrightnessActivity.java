...
/**
 * Created by ndnnga on 7/5/2017.
 */

public class BrightnessActivity  extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initViews(){
        ...
        image = BitmapFactory.decodeResource(getResources(),R.mipmap.fbdev);
